...
def draw_screen():
    ...
    speed_txt_render = speed_txt_font.render("Speed", True, GRAY)
    screen.blit(speed_txt_render, (45, 150))
    ...
    rpm_txt_render = rpm_txt_font.render("RPM", True, GRAY)
    screen.blit(rpm_txt_render, (352, 150))
    ...
    load_txt_render = load_txt_font.render("Load", True, GRAY)
    ...
    more_info_font = pygame.font.SysFont(wen_quan_font, 18)
    txt1 = more_info_font.render("Ambient temp", True, WHITE)
    screen.blit(txt1, (18, 252))
    txt2 = more_info_font.render("Coolant temp", True, WHITE)
    screen.blit(txt2, (138, 252))
    txt3 = more_info_font.render("Intake temp", True, WHITE)
    screen.blit(txt3, (257, 252))
    txt4 = more_info_font.render("Intake press", True, WHITE)
